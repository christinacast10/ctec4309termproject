...
?>
    ...
    <p>We proudly provide moving services to the following areas within the <?php echo $page_title; ?>:</p>
    <div class="areas-list">
    <ul>
        <li><span class="area-icon">&#x1F4CD;</span> Argyle</li>
        <li><span class="area-icon">&#x1F4CD;</span> Denton</li>
        <li><span class="area-icon">&#x1F4CD;</span> Double Oak</li>
        <li><span class="area-icon">&#x1F4CD;</span> Flower Mound</li>
        <li><span class="area-icon">&#x1F4CD;</span> Highland Village</li>
        <li><span class="area-icon">&#x1F4CD;</span> Justin</li>
        <li><span class="area-icon">&#x1F4CD;</span> Krum</li>
        <li><span class="area-icon">&#x1F4CD;</span> Lake Dallas</li>
        <li><span class="area-icon">&#x1F4CD;</span> Lewisville</li>
        <li><span class="area-icon">&#x1F4CD;</span> Northlake</li>
    </ul>
    </div>
</section>
