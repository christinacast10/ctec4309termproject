...
function dbConnect(){
	...
	$user = "cac0996_christinauser"; // put your own user name here.
	$pwd = "Maverick13#08!!"; // put your own database password here
	$database = "cac0996_4321"; // put your database name here
