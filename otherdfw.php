...
?>
    ...
    <p>We proudly provide moving services to the following areas within <?php echo $page_title; ?>:</p>
    <div class="areas-list">
    <ul>
        <li><span class="area-icon">&#x1F4CD;</span> Blue Ridge</li>
        <li><span class="area-icon">&#x1F4CD;</span> Cleburne</li>
        <li><span class="area-icon">&#x1F4CD;</span> Coppell</li>
        <li><span class="area-icon">&#x1F4CD;</span> Corinth</li>
        <li><span class="area-icon">&#x1F4CD;</span> Cross Roads</li>
        <li><span class="area-icon">&#x1F4CD;</span> Joshua</li>
        <li><span class="area-icon">&#x1F4CD;</span> Kennedale</li>
        <li><span class="area-icon">&#x1F4CD;</span> Lake Worth</li>
        <li><span class="area-icon">&#x1F4CD;</span> Lantana</li>
        <li><span class="area-icon">&#x1F4CD;</span> Trophy Club</li>
    </ul>
    </div>
</section>
